...
* 在`Debug`栏选择仿真工具为`J-LINK/J-TRACE Cortex`；选中`Run to main()`。如下图所示
  ...
  * 如果没有选择该选项，则先执行`startup_stm32f40_41xxx.s`文件的`Reset_Handler`，再跳到`main`函数。
  ...
  ![image-20210314190513493](assets/image-20210314190513493.png)
...
* 单击`Settings`设置`J-Link`的一些参数：
  ...
  * 单机`OK`完成这部分设置
  ...
  ![image-20210314214317615](assets/image-20210314214317615.png)
...
![image-20210504210109492](assets/image-20210504210109492.png)

#### 电容

* 无极性电容

  ![image-20210504210241558](assets/image-20210504210241558.png)

* 电解电容（有正负极）

  ![image-20210504210406315](assets/image-20210504210406315.png)

#### 电阻

* 普通电阻

  ![image-20210504210448297](assets/image-20210504210448297.png)

* 可变电阻

  ![image-20210504211237800](assets/image-20210504211237800.png)

#### 三极管

* NPN

  ![image-20210504210607800](assets/image-20210504210607800.png)

  ![image-20210504210746011](assets/image-20210504210746011.png)

* PNP

  ![image-20210504210657922](assets/image-20210504210657922.png)

#### 二极管

* 普通二极管

  ![image-20210504211004524](assets/image-20210504211004524.png)

* 发光二极管

  ![image-20210504211029318](assets/image-20210504211029318.png)

#### 开关

* 有锁定的开关

  ![image-20210504211458063](assets/image-20210504211458063.png)

* 无锁的微动开关

  ![image-20210504211550258](assets/image-20210504211550258.png)

#### 扬声器

* 喇叭

  ![image-20210504211728747](assets/image-20210504211728747.png)

* 蜂鸣器

  ![image-20210504211800140](assets/image-20210504211800140.png)

#### 芯片

* 普通芯片

  ![image-20210504212102850](assets/image-20210504212102850.png)

* 放大器

  ![image-20210504212224226](assets/image-20210504212224226.png)

* 反相器

  ![image-20210504212258075](assets/image-20210504212258075.png)

#### 继电器

![image-20210504212337136](assets/image-20210504212337136.png)

#### 电机

![image-20210504212403880](assets/image-20210504212403880.png)
